...
// For our lengthy computation, we’ll inefficiently confirm that a large prime number is prime:
...
fn main() {
    ...
    // a future that resolves to one of the above values -- whichever completes first!
